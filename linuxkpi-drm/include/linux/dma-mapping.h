 ...
 * dma_map_*. Backed by raeen_linuxkpi's zero-copy dma_alloc_coherent facade (P3)
...
/* coherent (consistent) allocations — backed by raeen_linuxkpi (M4) */
void *dma_alloc_coherent(struct device *dev, size_t size, dma_addr_t *dma_handle, gfp_t gfp);
void  dma_free_coherent(struct device *dev, size_t size, void *cpu_addr, dma_addr_t dma_handle);

/* streaming maps — backed by raeen_linuxkpi (M4) */
...
/* mask configuration — backed by raeen_linuxkpi (M4) */
