 ...
 * cross-CPU call are backed by ath_linuxkpi at M4 (a constant-0 processor id
...
/* real CPU id + topology — backed by ath_linuxkpi (M4) */
...
/* cross-CPU function call — backed by ath_linuxkpi (M4) */
