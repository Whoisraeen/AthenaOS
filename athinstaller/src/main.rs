//! athinstaller — AthenaOS premium installer (MasterChecklist Phase 3.1 + 16.1).
//!
...
const STAGE_ATHFS_FORMAT: u64 = 1 << 3;
const STAGE_VERIFY: u64 = 1 << 4;
const STAGE_ALL: u64 =
    STAGE_GPT | STAGE_ESP_FORMAT | STAGE_BOOT_TREE | STAGE_ATHFS_FORMAT | STAGE_VERIFY;
...
const ACCOUNT_USER: &[u8] = b"athenauser";
...
pub extern "C" fn _start() -> ! {
    unsafe {
        ...
        if result & STAGE_ATHFS_FORMAT != 0 {
            sys_print(10004);
        }
