...
impl SystemMonitor {
    ...
    pub fn render(&self, canvas: &mut athgfx::Canvas, x: usize, y: usize, w: usize, h: usize) {
    ...
    fn render_overview(&self, canvas: &mut athgfx::Canvas, x: usize, y: usize, w: usize, h: usize) {
        let panel_h = h / 3;
