...
impl FontConfig {
    pub fn default_fonts() -> Self {
        Self {
            system_font: String::from("AthenaSans"),
            monospace_font: String::from("AthenaMono"),
            heading_font: String::from("AthenaSans"),
            base_size_pt: 14,
            weight: 400,
        }
    }
...
pub fn preset_studio_ghibli_morning() -> VibeProfile {
    ...
    v.fonts = FontConfig {
        system_font: String::from("AthenaRound"),
        monospace_font: String::from("AthenaMono"),
        heading_font: String::from("AthenaRound"),
        base_size_pt: 15,
        weight: 400,
    };
    v
...
pub fn preset_bauhaus() -> VibeProfile {
    ...
    v.fonts = FontConfig {
        system_font: String::from("AthenaGeo"),
        monospace_font: String::from("AthenaMono"),
        heading_font: String::from("AthenaGeo"),
        base_size_pt: 14,
        weight: 500,
    };
    v
