...
impl SnapAssist {
    ...
    fn tile_rects(&self) -> Vec<Rect> {
        ...
        let gap = ath_tokens::SPACE_3 as i32;
    ...
    pub fn render(&self, canvas: &mut athgfx::Canvas) {
        ...
        if let Some(target) = self.current_target() {
            ...
            canvas.draw_text_aa(
                z.x + ath_tokens::SPACE_4 as i32,
                z.y + ath_tokens::SPACE_3 as i32,
                "Pick a window",
            ...
            for (i, t) in tiles.iter().enumerate() {
                ...
                if let Some(c) = self.candidates.get(i) {
                    canvas.draw_text_aa(
                        t.x + ath_tokens::SPACE_2 as i32,
                        t.y + t.h as i32 - ath_tokens::SPACE_5 as i32,
                        &c.title,
