...
//! **demuxer** the `athplay` video player and the `apps/music` `.m4a` path sit on.
//!
...
//! `athmedia`-style decoder consumes to produce `AudioFrame`s / video frames.
//!
//! ## What is modeled
...
//! bottom of this file is the primary proof (`cargo test -p ath_mp4`).
