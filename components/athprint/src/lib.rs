...
impl PrintManager {
    pub fn new() -> Self {
        ...
        Self {
            ...
            queues: BTreeMap::new(),
            spooler: Spooler::new(String::from("/var/spool/athprint")),
            filter_chain,
...
// ===========================================================================
// Host KAT suite — FAIL-able, concrete-value asserts (cargo test -p athprint)
// ===========================================================================
#[cfg(test)]
mod tests {
    ...
    fn pdf_compressed_uses_flatedecode_and_roundtrips() {
        ...
        let decoded = ath_deflate::zlib_decompress(&pdf[start..end])
