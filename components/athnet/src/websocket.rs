...
impl WebSocket {
    ...
    fn build_handshake_request(&mut self, url: &str, protocols: &[&str]) -> Vec<u8> {
        ...
        let key = ath_encode::base64_encode(&nonce);
    ...
    fn compute_accept_key(key: &str) -> String {
        ...
        let digest = ath_hash::sha1(combined.as_bytes());
        ath_encode::base64_encode(&digest)
    }
...
mod tests {
    ...
    // input parser flagged in athnet. decode_frame is fed raw bytes straight
