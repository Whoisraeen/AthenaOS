...
//! no_std link of athnet never pulls these in; the userspace daemon and the
//! host KATs (`cargo test -p athnet --features tls13`) do.
...
// ── Host KATs (cargo test -p athnet --features tls13) ────────────────────────
...
mod tests {
    ...
    //
    // ED25519_CERT: CN=athenatested, valid 2025-01-01T00:00:00Z .. 2035-01-01Z.
    ...
    // P256_CERT: CN=athenatestp256, valid 2025-06-01T00:00:00Z .. 2034-06-01Z.
    ...
    //   `openssl genrsa 2048` + `openssl req -x509 -sha256`, SAN=athnet-rsa.example.com,
    ...
    //   P384_LEAF_CERT — "CN=athnet-p384.example.com" (SAN dNSName), signed by root.
    ...
    // P-384 leaf, SAN=athnet-p384.example.com, signed by P384_ROOT_CERT.
