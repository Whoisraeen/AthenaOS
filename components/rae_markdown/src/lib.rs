...
//!   belongs to the consuming app + raeui later; this slice ships the *model*).
//!
//! ## Subset supported
...
//! is the primary proof (`cargo test -p rae_markdown`).
...
/// overflow the stack (a DoS). Mirrors the depth guard in rae_json / rae_toml.
...
/// smoketest aid (the on-screen render belongs to the consuming app + raeui);
...
// ===========================================================================
// Host KAT suite — `cargo test -p rae_markdown`
// ===========================================================================
#[cfg(test)]
mod tests {
    use super::*;
    ...
    //
    // Matches the rae_json/rae_toml/rae_gif pattern that landed this session: a
    ...
    /// fuzzer surfaced). rae_json/rae_toml cap nesting with MAX_DEPTH → Err; this
