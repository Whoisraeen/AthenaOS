    ...
    T: 'a + core::fmt::Debug,
{
    ...
    pub device_history: ArrayDeque<Option<core::num::NonZeroU8>, 8, arraydeque::behavior::Wrapping>,
...
#[derive(Debug)]
pub(crate) enum WaitingConfig<'a, T: 'a + core::fmt::Debug> {
...
#[derive(Debug)]
pub struct WaitingState<'a, T: 'a + core::fmt::Debug> {
    coord: KCoord,
    timeout: u16,
...
impl<'a, T: core::fmt::Debug> WaitingState<'a, T> {
    fn tick_wt(
        &mut self,
        queued: &mut Queue,
...
impl<'a, const C: usize, const R: usize, T: 'a + Copy + core::fmt::Debug> Layout<'a, C, R, T> {
