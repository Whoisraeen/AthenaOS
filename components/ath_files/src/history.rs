...
mod tests {
    ...
    fn navigate_builds_back_forward() {
        let mut t = Tab::new("/home/athena").unwrap();
        t.navigate("/home/athena/Documents").unwrap();
        t.navigate("/home/athena/Documents/sub").unwrap();
        assert_eq!(t.cwd(), "/home/athena/Documents/sub");
        assert!(t.can_back());
        assert!(!t.can_forward());
        assert_eq!(t.back(), Some("/home/athena/Documents"));
        assert_eq!(t.back(), Some("/home/athena"));
        assert_eq!(t.back(), None); // at start
        assert!(t.can_forward());
        assert_eq!(t.forward(), Some("/home/athena/Documents"));
    }
