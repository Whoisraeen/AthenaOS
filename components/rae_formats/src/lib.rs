...
//! decoder crate** (no `rae_png`/`rae_pdf`/`rae_mp4`/…): a sniffer that pulled in
...
impl FileKind {
    ...
    pub fn recommended_decoder(self) -> Option<&'static str> {
        ...
        Some(match self {
            ...
            Docx => "rae_docx",
            Xlsx => "rae_xlsx",
            Mp4 | M4a | QuickTime | Heif => "rae_mp4",
            Zip => "rae_zip",
            Gzip => "rae_deflate",
            Tar => "rae_tar",
            Markdown => "rae_markdown",
            Html => "rae_web",
            _ => return None,
        })
    }
...
// ---------------------------------------------------------------------------
// Extension-hint mapping (no rae_mime dependency — kept inline & minimal)
// ---------------------------------------------------------------------------
...
// ===========================================================================
// Host KATs — the primary, FAIL-able proof. `cargo test -p rae_formats`.
//
...
mod tests {
    ...
    fn metadata_accessors() {
        ...
        assert_eq!(FileKind::Png.recommended_decoder(), Some("rae_png"));
