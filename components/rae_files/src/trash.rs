...
/// The trash bucket name under the session home (e.g. `/home/raeen/.Trash`).
...
/// `home = "/home/raeen"` → `"/home/raeen/.Trash"`. The app `mkdir`s this once
...
mod tests {
    ...
    const HOME: &str = "/home/raeen";

    #[test]
    fn trash_dir_is_dotted_under_home() {
        let d = trash_dir_for_home(HOME).unwrap();
        assert_eq!(d.as_str(), "/home/raeen/.Trash");
    }

    #[test]
    fn trash_target_keeps_file_name() {
        let t = trash_target("/home/raeen/Documents/notes.txt", HOME).unwrap();
        assert_eq!(t.as_str(), "/home/raeen/.Trash/notes.txt");
    }

    #[test]
    fn trash_then_restore_round_trips() {
        let trashed = trash_target("/home/raeen/Pictures/photo.png", HOME).unwrap();
        assert_eq!(trashed.as_str(), "/home/raeen/.Trash/photo.png");
        // Restore back to the original parent.
        let restored = restore_target(trashed.as_str(), HOME, "/home/raeen/Pictures").unwrap();
        assert_eq!(restored.as_str(), "/home/raeen/Pictures/photo.png");
    }

    #[test]
    fn refuses_to_trash_something_already_trashed() {
        assert_eq!(
            trash_target("/home/raeen/.Trash/old.txt", HOME),
    ...
    fn refuses_to_restore_a_non_trash_path() {
        assert_eq!(
            restore_target("/home/raeen/Documents/x.txt", HOME, "/home/raeen"),
    ...
    fn is_in_trash_does_not_match_sibling_prefixes() {
        ...
        assert!(!is_in_trash("/home/raeen/.TrashCan/x", HOME));
        assert!(is_in_trash("/home/raeen/.Trash/x", HOME));
    }
    ...
    fn fail_able_wrong_target_is_rejected() {
        ...
        let t = trash_target("/home/raeen/a.txt", HOME).unwrap();
        assert_ne!(t.as_str(), "/home/raeen/.Trash/a"); // extension MUST be kept
        assert_ne!(t.as_str(), "/home/raeen/Trash/a.txt"); // bucket MUST be dotted
    }
}
