...
//! the machine": when you download a kernel image, an installer, a `.athpkg`, or
...
//! action, and `.athpkg` sideload verification — so it is deliberately wired into
//! none this slice.
//!
...
//! (`cargo test -p ath_hash`) and uses the NIST FIPS 180-4 / RFC 1321 / IEEE
...
// ===========================================================================
// Host KAT suite — `cargo test -p ath_hash`. FAIL-able: each assert is a
