...
//!
//! See `docs/components/raecloud.md` for the design.
...
impl KeyManager {
    ...
    pub fn encrypt_blob(&self, plaintext: &[u8], nonce: [u8; 12]) -> Result<Vec<u8>> {
        ...
        let sealed = rae_crypto::chacha20poly1305::seal(&key.key_data, &nonce, &[], plaintext);
    ...
    pub fn decrypt_blob(&self, key_id: u64, ciphertext: &[u8]) -> Result<Vec<u8>> {
        ...
        rae_crypto::chacha20poly1305::open(&key.key_data, &nonce, &[], &ciphertext[12..])
