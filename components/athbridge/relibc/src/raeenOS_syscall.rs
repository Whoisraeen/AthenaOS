...
// SYS_DEBUG_PRINT moved from 27 to 141 in ath_abi v2 — was colliding with
// SYS_SURFACE_CLOSE in the kernel match. See docs/SYSCALL_TABLE.md and
// components/ath_abi/src/lib.rs::syscall::SYS_DEBUG_PRINT.
...
/// Native futex (ath_abi::syscall::SYS_FUTEX). rdi=uaddr, rsi=op (0=wait,
...
// ── Public syscall API (used by platform/athena) ─────────────────────────────
