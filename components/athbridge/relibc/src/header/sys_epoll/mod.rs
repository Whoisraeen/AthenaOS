...
/// Set the close-on-exec (`FD_CLOEXEC`) flag on the new file descriptor.
#[cfg(any(target_os = "redox", target_os = "none"))]
...
/// Non-POSIX, see <https://man7.org/linux/man-pages/man3/epoll_event.3type.html>.
#[cfg(all(any(target_os = "redox", target_os = "none"), target_pointer_width = "64"))]
#[repr(C)]
...
/// Non-POSIX, see <https://man7.org/linux/man-pages/man3/epoll_event.3type.html>.
#[cfg(not(all(any(target_os = "redox", target_os = "none"), target_pointer_width = "64")))]
#[repr(C)]
#[derive(Clone, Copy, Default)]
pub struct epoll_event {
    pub events: c_uint,
