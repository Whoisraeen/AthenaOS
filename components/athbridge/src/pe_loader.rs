...
pub fn athena_error_to_win32(err: &AthenaOsError) -> u32 {
    match err {
        AthenaOsError::NotFound => crate::ERROR_FILE_NOT_FOUND,
        AthenaOsError::PermissionDenied => crate::ERROR_ACCESS_DENIED,
        AthenaOsError::AlreadyExists => crate::ERROR_ALREADY_EXISTS,
        AthenaOsError::InvalidArgument => crate::ERROR_INVALID_PARAMETER,
        AthenaOsError::OutOfMemory => crate::ERROR_NOT_ENOUGH_MEMORY,
        AthenaOsError::NotSupported => crate::ERROR_NOT_SUPPORTED,
        AthenaOsError::Busy => crate::ERROR_SHARING_VIOLATION,
        AthenaOsError::IoError => crate::ERROR_INVALID_DATA,
        AthenaOsError::TooManyHandles => crate::ERROR_TOO_MANY_OPEN_FILES,
        AthenaOsError::InvalidHandle => crate::ERROR_INVALID_HANDLE,
        AthenaOsError::BufferTooSmall => crate::ERROR_INSUFFICIENT_BUFFER,
        AthenaOsError::EndOfFile => crate::ERROR_HANDLE_EOF,
        AthenaOsError::NoAccess => crate::ERROR_NOACCESS,
    }
}

/// Abstraction over AthenaOS native error categories.
#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub enum AthenaOsError {
    NotFound,
    PermissionDenied,
    AlreadyExists,
    InvalidArgument,
...
mod tests {
    ...
    #[test]
    fn test_athena_error_translation() {
        assert_eq!(
            athena_error_to_win32(&AthenaOsError::NotFound),
            crate::ERROR_FILE_NOT_FOUND
        );
        assert_eq!(
            athena_error_to_win32(&AthenaOsError::PermissionDenied),
            crate::ERROR_ACCESS_DENIED
        );
        assert_eq!(
            athena_error_to_win32(&AthenaOsError::OutOfMemory),
