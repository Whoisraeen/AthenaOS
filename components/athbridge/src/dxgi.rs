...
impl DxgiFormat {
    ...
    pub fn to_athgfx(&self) -> Option<athgfx::PixelFormat> {
        match self {
            Self::R8G8B8A8Unorm => Some(athgfx::PixelFormat::Rgba8Unorm),
            Self::R8G8B8A8UnormSrgb => Some(athgfx::PixelFormat::Rgba8Srgb),
            Self::B8G8R8A8Unorm => Some(athgfx::PixelFormat::Bgra8Unorm),
            Self::B8G8R8A8UnormSrgb => Some(athgfx::PixelFormat::Bgra8Srgb),
            Self::R16G16B16A16Float => Some(athgfx::PixelFormat::Rgba16Float),
            Self::R32G32B32A32Float => Some(athgfx::PixelFormat::Rgba32Float),
            Self::R11G11B10Float => Some(athgfx::PixelFormat::Rg11B10Float),
            Self::D24UnormS8Uint => Some(athgfx::PixelFormat::Depth24Stencil8),
            Self::D32Float => Some(athgfx::PixelFormat::Depth32Float),
            Self::R8Unorm => Some(athgfx::PixelFormat::R8Unorm),
            Self::Bc1Unorm => Some(athgfx::PixelFormat::Bc1Unorm),
            Self::Bc3Unorm => Some(athgfx::PixelFormat::Bc3Unorm),
            Self::Bc7Unorm => Some(athgfx::PixelFormat::Bc7Unorm),
            _ => None,
        }
    }
...
impl DxgiFactory {
    pub fn new(flags: u32) -> Self {
        Self {
            adapters: vec![DxgiAdapter::athena_default()],
            flags,
        }
    }
...
impl D3d11PrimitiveTopology {
    pub fn to_athgfx(&self) -> athgfx::PrimitiveTopology {
        match self {
            Self::PointList => athgfx::PrimitiveTopology::PointList,
            Self::LineList | Self::LineListAdj => athgfx::PrimitiveTopology::LineList,
            Self::LineStrip | Self::LineStripAdj => athgfx::PrimitiveTopology::LineStrip,
            Self::TriangleList | Self::TriangleListAdj => athgfx::PrimitiveTopology::TriangleList,
            Self::TriangleStrip | Self::TriangleStripAdj => {
                athgfx::PrimitiveTopology::TriangleStrip
            }
            Self::Undefined => athgfx::PrimitiveTopology::TriangleList,
        }
    }
}
...
impl D3d11TextureAddressMode {
    pub fn to_athgfx(&self) -> athgfx::AddressMode {
        match self {
            Self::Wrap => athgfx::AddressMode::Repeat,
            Self::Mirror | Self::MirrorOnce => athgfx::AddressMode::MirroredRepeat,
            Self::Clamp => athgfx::AddressMode::ClampToEdge,
            Self::Border => athgfx::AddressMode::ClampToBorder,
        }
    }
}
...
fn d3d11_blend_to_athgfx(val: u32) -> athgfx::BlendFactor {
    match val {
        1 => athgfx::BlendFactor::One,
        2 => athgfx::BlendFactor::Zero,
        3 => athgfx::BlendFactor::SrcColor,
        4 => athgfx::BlendFactor::OneMinusSrcColor,
        5 => athgfx::BlendFactor::SrcAlpha,
        6 => athgfx::BlendFactor::OneMinusSrcAlpha,
        7 => athgfx::BlendFactor::DstAlpha,
        8 => athgfx::BlendFactor::OneMinusDstAlpha,
        9 => athgfx::BlendFactor::DstColor,
        10 => athgfx::BlendFactor::OneMinusDstColor,
        _ => athgfx::BlendFactor::One,
    }
}

fn d3d11_blend_op_to_athgfx(val: u32) -> athgfx::BlendOp {
    match val {
        1 => athgfx::BlendOp::Add,
        2 => athgfx::BlendOp::Subtract,
        3 => athgfx::BlendOp::ReverseSubtract,
        4 => athgfx::BlendOp::Min,
        5 => athgfx::BlendOp::Max,
        _ => athgfx::BlendOp::Add,
    }
}
...
impl D3d11BlendState {
    pub fn to_athgfx(&self) -> athgfx::BlendState {
        athgfx::BlendState {
            ...
            src_factor: d3d11_blend_to_athgfx(self.src_blend),
            dst_factor: d3d11_blend_to_athgfx(self.dest_blend),
            op: d3d11_blend_op_to_athgfx(self.blend_op),
            src_alpha_factor: d3d11_blend_to_athgfx(self.src_blend_alpha),
            dst_alpha_factor: d3d11_blend_to_athgfx(self.dest_blend_alpha),
            alpha_op: d3d11_blend_op_to_athgfx(self.blend_op_alpha),
        }
    }
}
...
impl D3d11SamplerState {
    pub fn to_athgfx(&self) -> athgfx::SamplerDescriptor {
        let (min, mag, mip) = match self.filter {
            D3d11Filter::MinMagMipPoint => (
                athgfx::FilterMode::Nearest,
                athgfx::FilterMode::Nearest,
                athgfx::FilterMode::Nearest,
            ),
            D3d11Filter::MinMagMipLinear | D3d11Filter::ComparisonMinMagMipLinear => (
                athgfx::FilterMode::Linear,
                athgfx::FilterMode::Linear,
                athgfx::FilterMode::Linear,
            ),
            D3d11Filter::Anisotropic | D3d11Filter::ComparisonAnisotropic => {
                let aniso = athgfx::FilterMode::Anisotropic(self.max_anisotropy.min(16) as u8);
                (aniso, aniso, athgfx::FilterMode::Linear)
            }
        ...
        let compare = match self.filter {
            D3d11Filter::ComparisonMinMagMipLinear | D3d11Filter::ComparisonAnisotropic => {
                Some(self.comparison.to_athgfx())
            }
            _ => None,
        };
        athgfx::SamplerDescriptor {
            min_filter: min,
            mag_filter: mag,
            mipmap_filter: mip,
            address_u: self.address_u.to_athgfx(),
            address_v: self.address_v.to_athgfx(),
            address_w: self.address_w.to_athgfx(),
...
pub fn translate_d3d11_to_athgfx(
    commands: &[D3d11Command],
    state: &D3d11PipelineState,
) -> Vec<athgfx::DrawCommand> {
    let mut out = Vec::new();

    for vp in &state.viewports {
        out.push(athgfx::DrawCommand::SetViewport {
            x: vp.top_left_x,
            y: vp.top_left_y,
            width: vp.width,
            height: vp.height,
    ...
    for sc in &state.scissors {
        out.push(athgfx::DrawCommand::SetScissor {
            x: sc.left,
            y: sc.top,
    ...
    for (i, &(buf_handle, _stride, offset)) in state.vertex_buffers.iter().enumerate() {
        if buf_handle != 0 {
            out.push(athgfx::DrawCommand::BindVertexBuffer {
                slot: i as u32,
                buffer: athgfx::BufferHandle(buf_handle),
    ...
    if let Some((buf, fmt, offset)) = &state.index_buffer {
        let index_type = match fmt {
            DxgiFormat::R16Unorm | DxgiFormat::R16Uint => athgfx::IndexType::U16,
            _ => athgfx::IndexType::U32,
        };
        out.push(athgfx::DrawCommand::BindIndexBuffer {
            buffer: athgfx::BufferHandle(*buf),
            offset: *offset as u64,
            index_type,
        });
    }
    ...
    for cmd in commands {
        match cmd {
            D3d11Command::Draw(vertex_count, start_vertex) => {
                out.push(athgfx::DrawCommand::Draw {
            ...
            D3d11Command::DrawIndexed(index_count, start_index, base_vertex) => {
                out.push(athgfx::DrawCommand::DrawIndexed {
            ...
            D3d11Command::Dispatch(x, y, z) => {
                out.push(athgfx::DrawCommand::Dispatch {
                    x: *x,
                    y: *y,
                    z: *z,
                });
...
impl DxbcShader {
    ...
    pub fn shader_stage(&self) -> athgfx::ShaderStage {
        match self.shader_type {
            D3d11ShaderType::Vertex => athgfx::ShaderStage::Vertex,
            D3d11ShaderType::Pixel => athgfx::ShaderStage::Fragment,
            D3d11ShaderType::Geometry => athgfx::ShaderStage::Geometry,
            D3d11ShaderType::Hull => athgfx::ShaderStage::TessControl,
            D3d11ShaderType::Domain => athgfx::ShaderStage::TessEvaluation,
            D3d11ShaderType::Compute => athgfx::ShaderStage::Compute,
        }
    }
}
...
pub fn translate_d3d12_to_athgfx(commands: &[D3d12Command]) -> Vec<athgfx::DrawCommand> {
    let mut out = Vec::new();
    ...
    for cmd in commands {
        match cmd {
            ...
            D3d12Command::SetGraphicsRoot32BitConstants(_, data) => {
                ...
                out.push(athgfx::DrawCommand::PushConstants {
                    offset: 0,
                    data: bytes,
                });
            }
...
impl DxgiTranslationRuntime {
    ...
    pub fn flush_d3d11(&mut self) -> Result<Vec<athgfx::DrawCommand>, DxgiError> {
        let ctx = self
            .d3d11_context
            .as_mut()
        ...
        let athgfx_commands = translate_d3d11_to_athgfx(&commands, &ctx.state);
        Ok(athgfx_commands)
    }
}
