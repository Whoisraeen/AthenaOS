...
//! Canvas pixel format, **matching [`ath_png`]/`ath_bmp`/`ath_gif`** so a gallery,
...
//! this file is the primary proof (`cargo test -p ath_webp`).
...
/// identical to [`ath_png`]/`ath_bmp`/`ath_gif` so callers consume every AthenaOS
...
/// way [`ath_png`] / [`ath_deflate`] do: walk bit-by-bit accumulating the code,
...
// ════════════════════════════════════════════════════════════════════════════
// Host KAT suite — `cargo test -p ath_webp`. FAIL-able by construction.
//
