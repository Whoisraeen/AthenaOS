...
// ═══════════════════════════════════════════════════════════════════════════
// Format enum — maps to athgfx::PixelFormat
// ═══════════════════════════════════════════════════════════════════════════
...
impl VkFormat {
    pub fn to_athgfx(self) -> Option<crate::PixelFormat> {
        match self {
    ...
    pub fn from_athgfx(fmt: crate::PixelFormat) -> Self {
        match fmt {
...
impl VkImage {
    ...
    pub fn memory_requirements(&self) -> VkMemoryRequirements {
        let texel_size = match self.format.to_athgfx() {
