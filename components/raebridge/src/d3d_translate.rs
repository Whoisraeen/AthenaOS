...
impl DxgiFormat {
    ...
    pub fn to_raegfx(self) -> Option<raegfx::PixelFormat> {
        match self {
            ...
            | Self::R8G8B8A8_Uint
            | Self::R8G8B8A8_Snorm
            | Self::R8G8B8A8_Sint => Some(raegfx::PixelFormat::Rgba8Unorm),
            Self::R8G8B8A8_Unorm_Srgb => Some(raegfx::PixelFormat::Rgba8Srgb),
            Self::B8G8R8A8_Unorm
            | Self::B8G8R8A8_Typeless
            | Self::B8G8R8X8_Unorm
            | Self::B8G8R8X8_Typeless => Some(raegfx::PixelFormat::Bgra8Unorm),
            Self::B8G8R8A8_Unorm_Srgb | Self::B8G8R8X8_Unorm_Srgb => {
                Some(raegfx::PixelFormat::Bgra8Srgb)
            }
            ...
            Self::R32G32B32A32_Float | Self::R32G32B32A32_Typeless => {
                Some(raegfx::PixelFormat::Rgba32Float)
            }
            Self::R11G11B10_Float => Some(raegfx::PixelFormat::Rg11B10Float),
            Self::D24_Unorm_S8_Uint | Self::R24G8_Typeless => {
                Some(raegfx::PixelFormat::Depth24Stencil8)
            }
            Self::D32_Float | Self::R32_Typeless => Some(raegfx::PixelFormat::Depth32Float),
            Self::D32_Float_S8X24_Uint | Self::R32G8X24_Typeless => {
                Some(raegfx::PixelFormat::Depth32Float)
            }
            Self::R8_Unorm
            | Self::R8_Typeless
            | Self::R8_Uint
            | Self::R8_Snorm
            | Self::R8_Sint
            | Self::A8_Unorm => Some(raegfx::PixelFormat::R8Unorm),
            Self::R8G8_Unorm
            | Self::R8G8_Typeless
            | Self::R8G8_Uint
            | Self::R8G8_Snorm
            | Self::R8G8_Sint => Some(raegfx::PixelFormat::Rg8Unorm),
            Self::BC1_Unorm | Self::BC1_Typeless | Self::BC1_Unorm_Srgb => {
                Some(raegfx::PixelFormat::Bc1Unorm)
            }
            Self::BC2_Unorm
            | Self::BC2_Typeless
            | Self::BC2_Unorm_Srgb
            | Self::BC3_Unorm
            | Self::BC3_Typeless
            | Self::BC3_Unorm_Srgb => Some(raegfx::PixelFormat::Bc3Unorm),
            ...
            Self::R10G10B10A2_Unorm | Self::R10G10B10A2_Typeless | Self::R10G10B10A2_Uint => {
                Some(raegfx::PixelFormat::Rgba8Unorm)
            }
            _ => None,
        }
    }
...
fn bind_flags_to_buffer_usage(flags: u32) -> raegfx::BufferUsage {
    if flags & (D3d11BindFlag::VertexBuffer as u32) != 0 {
        raegfx::BufferUsage::Vertex
    } else if flags & (D3d11BindFlag::IndexBuffer as u32) != 0 {
        raegfx::BufferUsage::Index
    } else if flags & (D3d11BindFlag::ConstantBuffer as u32) != 0 {
        raegfx::BufferUsage::Uniform
    } else if flags & (D3d11BindFlag::UnorderedAccess as u32) != 0 {
        raegfx::BufferUsage::Storage
    } else if flags & (D3d11BindFlag::StreamOutput as u32) != 0 {
        raegfx::BufferUsage::Storage
    } else {
        raegfx::BufferUsage::Transfer
    }
}

fn bind_flags_to_texture_usage(flags: u32) -> raegfx::TextureUsage {
    if flags & (D3d11BindFlag::RenderTarget as u32) != 0 {
        raegfx::TextureUsage::RenderTarget
    } else if flags & (D3d11BindFlag::DepthStencil as u32) != 0 {
        raegfx::TextureUsage::DepthStencil
    } else if flags & (D3d11BindFlag::UnorderedAccess as u32) != 0 {
        raegfx::TextureUsage::Storage
    } else {
        raegfx::TextureUsage::Sampled
    }
}
...
impl D3d11BufferDesc {
    pub fn to_raegfx(&self) -> raegfx::BufferDescriptor {
        raegfx::BufferDescriptor {
...
impl D3d11Texture2dDesc {
    pub fn to_raegfx(&self) -> Option<raegfx::TextureDescriptor> {
        let format = self.format.to_raegfx()?;
        Some(raegfx::TextureDescriptor {
            width: self.width,
            height: self.height,
...
impl D3d11Blend {
    pub fn to_raegfx(self) -> raegfx::BlendFactor {
        match self {
            Self::Zero => raegfx::BlendFactor::Zero,
            Self::One => raegfx::BlendFactor::One,
            Self::SrcColor => raegfx::BlendFactor::SrcColor,
            Self::InvSrcColor => raegfx::BlendFactor::OneMinusSrcColor,
            Self::SrcAlpha => raegfx::BlendFactor::SrcAlpha,
            Self::InvSrcAlpha => raegfx::BlendFactor::OneMinusSrcAlpha,
            Self::DestAlpha => raegfx::BlendFactor::DstAlpha,
            Self::InvDestAlpha => raegfx::BlendFactor::OneMinusDstAlpha,
            Self::DestColor => raegfx::BlendFactor::DstColor,
            Self::InvDestColor => raegfx::BlendFactor::OneMinusDstColor,
            Self::SrcAlphaSat => raegfx::BlendFactor::SrcAlpha,
            Self::BlendFactor => raegfx::BlendFactor::One,
            Self::InvBlendFactor => raegfx::BlendFactor::Zero,
        }
    }
}
...
impl D3d11BlendOp {
    pub fn to_raegfx(self) -> raegfx::BlendOp {
        match self {
            Self::Add => raegfx::BlendOp::Add,
            Self::Subtract => raegfx::BlendOp::Subtract,
            Self::RevSubtract => raegfx::BlendOp::ReverseSubtract,
            Self::Min => raegfx::BlendOp::Min,
            Self::Max => raegfx::BlendOp::Max,
        }
    }
}
...
impl D3d11BlendDesc {
    pub fn to_raegfx(&self) -> raegfx::BlendState {
        raegfx::BlendState {
            ...
            src_factor: self.src_blend.to_raegfx(),
            dst_factor: self.dest_blend.to_raegfx(),
            op: self.blend_op.to_raegfx(),
            src_alpha_factor: self.src_blend_alpha.to_raegfx(),
            dst_alpha_factor: self.dest_blend_alpha.to_raegfx(),
            alpha_op: self.blend_op_alpha.to_raegfx(),
        }
    }
}
...
impl D3d12ResourceState {
    pub fn to_raegfx_layout(self) -> raegfx::ImageLayout {
        match self {
            Self::Common | Self::Present => raegfx::ImageLayout::PresentSrc,
            Self::RenderTarget => raegfx::ImageLayout::ColorAttachment,
            Self::DepthWrite | Self::DepthRead => raegfx::ImageLayout::DepthStencilAttachment,
            Self::PixelShaderResource | Self::NonPixelShaderResource | Self::GenericRead => {
                raegfx::ImageLayout::ShaderReadOnly
            }
            Self::CopyDest => raegfx::ImageLayout::TransferDst,
            Self::CopySource => raegfx::ImageLayout::TransferSrc,
            Self::UnorderedAccess => raegfx::ImageLayout::General,
            _ => raegfx::ImageLayout::General,
        }
    }

    pub fn to_raegfx_access(self) -> raegfx::AccessFlags {
        match self {
            Self::Common | Self::Present => raegfx::AccessFlags::None,
            Self::VertexAndConstantBuffer => raegfx::AccessFlags::VertexBufferRead,
            Self::IndexBuffer => raegfx::AccessFlags::IndexBufferRead,
            Self::RenderTarget => raegfx::AccessFlags::ColorAttachmentWrite,
            Self::UnorderedAccess => raegfx::AccessFlags::ShaderWrite,
            Self::DepthWrite => raegfx::AccessFlags::DepthStencilWrite,
            Self::DepthRead => raegfx::AccessFlags::DepthStencilRead,
            Self::NonPixelShaderResource | Self::PixelShaderResource | Self::GenericRead => {
                raegfx::AccessFlags::ShaderRead
            }
            Self::CopyDest => raegfx::AccessFlags::TransferWrite,
            Self::CopySource => raegfx::AccessFlags::TransferRead,
        }
    }

    pub fn to_raegfx_stage(self) -> raegfx::PipelineStage {
        match self {
            Self::Common | Self::Present => raegfx::PipelineStage::BottomOfPipe,
            Self::VertexAndConstantBuffer | Self::IndexBuffer => raegfx::PipelineStage::VertexInput,
            Self::RenderTarget => raegfx::PipelineStage::ColorAttachmentOutput,
            Self::DepthWrite | Self::DepthRead => raegfx::PipelineStage::EarlyFragmentTests,
            Self::NonPixelShaderResource => raegfx::PipelineStage::VertexShader,
            Self::PixelShaderResource => raegfx::PipelineStage::FragmentShader,
            Self::UnorderedAccess => raegfx::PipelineStage::ComputeShader,
            Self::CopyDest | Self::CopySource => raegfx::PipelineStage::Transfer,
            Self::GenericRead => raegfx::PipelineStage::TopOfPipe,
        }
    }
}
...
impl D3d12ResourceBarrier {
    pub fn to_raegfx_image_barrier(&self) -> raegfx::ImageBarrier {
        raegfx::ImageBarrier {
            image: raegfx::TextureHandle(self.resource_handle),
            old_layout: self.state_before.to_raegfx_layout(),
            new_layout: self.state_after.to_raegfx_layout(),
            src_access: self.state_before.to_raegfx_access(),
            dst_access: self.state_after.to_raegfx_access(),
        }
    }

    pub fn to_raegfx_barrier_info(&self) -> raegfx::BarrierInfo {
        raegfx::BarrierInfo {
            src_stage: self.state_before.to_raegfx_stage(),
            dst_stage: self.state_after.to_raegfx_stage(),
            image_barriers: vec![self.to_raegfx_image_barrier()],
        }
    }
}

pub fn translate_barriers_to_raegfx(barriers: &[D3d12ResourceBarrier]) -> raegfx::BarrierInfo {
    let src_stage = barriers
        .first()
        .map(|b| b.state_before.to_raegfx_stage())
        .unwrap_or(raegfx::PipelineStage::TopOfPipe);
    let dst_stage = barriers
        .first()
        .map(|b| b.state_after.to_raegfx_stage())
        .unwrap_or(raegfx::PipelineStage::BottomOfPipe);

    let image_barriers = barriers
        .iter()
        .map(|b| b.to_raegfx_image_barrier())
        .collect();
...
impl D3d12DescriptorRangeType {
    pub fn to_raegfx(self) -> raegfx::DescriptorType {
        match self {
            Self::Srv => raegfx::DescriptorType::SampledImage,
            Self::Uav => raegfx::DescriptorType::StorageImage,
            Self::Cbv => raegfx::DescriptorType::UniformBuffer,
            Self::Sampler => raegfx::DescriptorType::Sampler,
        }
    }
}
...
impl D3d12ShaderVisibility {
    pub fn to_raegfx_stage(self) -> raegfx::ShaderStage {
        match self {
            Self::Vertex => raegfx::ShaderStage::Vertex,
            Self::Pixel => raegfx::ShaderStage::Fragment,
            Self::Geometry => raegfx::ShaderStage::Geometry,
            Self::Hull => raegfx::ShaderStage::TessControl,
            Self::Domain => raegfx::ShaderStage::TessEvaluation,
            Self::All => raegfx::ShaderStage::Vertex,
        }
    }
}
...
impl D3d12RootSignature {
    pub fn to_raegfx_bindings(&self) -> Vec<raegfx::DescriptorSetLayoutBinding> {
        ...
        for param in &self.parameters {
            for range in &param.ranges {
                for i in 0..range.num_descriptors {
                    bindings.push(raegfx::DescriptorSetLayoutBinding {
                        binding: binding_idx,
                        descriptor_type: range.range_type.to_raegfx(),
                        count: 1,
                        stage: param.visibility.to_raegfx_stage(),
                    });
                    binding_idx += 1;
                    let _ = i;
                }
    ...
    pub fn to_raegfx_push_constants(&self) -> Vec<raegfx::PushConstantRange> {
        ...
        for param in &self.parameters {
            if param.num_32bit_values > 0 {
                ...
                ranges.push(raegfx::PushConstantRange {
                    stage: param.visibility.to_raegfx_stage(),
                    offset,
                    size,
                });
...
impl DxbcShaderType {
    pub fn to_raegfx(self) -> raegfx::ShaderStage {
        match self {
            Self::Pixel => raegfx::ShaderStage::Fragment,
            Self::Vertex => raegfx::ShaderStage::Vertex,
            Self::Geometry => raegfx::ShaderStage::Geometry,
            Self::Hull => raegfx::ShaderStage::TessControl,
            Self::Domain => raegfx::ShaderStage::TessEvaluation,
            Self::Compute => raegfx::ShaderStage::Compute,
        }
    }
}
...
fn dxgi_format_to_vertex_format(format: DxgiFormat) -> Option<raegfx::VertexFormat> {
    match format {
        DxgiFormat::R32_Float => Some(raegfx::VertexFormat::Float),
        DxgiFormat::R32G32_Float => Some(raegfx::VertexFormat::Float2),
        DxgiFormat::R32G32B32_Float => Some(raegfx::VertexFormat::Float3),
        DxgiFormat::R32G32B32A32_Float => Some(raegfx::VertexFormat::Float4),
        DxgiFormat::R32_Sint | DxgiFormat::R32_Uint => Some(raegfx::VertexFormat::Int),
        DxgiFormat::R32G32_Sint | DxgiFormat::R32G32_Uint => Some(raegfx::VertexFormat::Int2),
        DxgiFormat::R32G32B32_Sint | DxgiFormat::R32G32B32_Uint => Some(raegfx::VertexFormat::Int3),
        DxgiFormat::R32G32B32A32_Sint | DxgiFormat::R32G32B32A32_Uint => {
            Some(raegfx::VertexFormat::Int4)
        }
        DxgiFormat::R8G8B8A8_Unorm | DxgiFormat::R8G8B8A8_Uint | DxgiFormat::B8G8R8A8_Unorm => {
            Some(raegfx::VertexFormat::UByte4Norm)
        }
        DxgiFormat::R16G16_Float => Some(raegfx::VertexFormat::Float2),
        DxgiFormat::R16G16B16A16_Float => Some(raegfx::VertexFormat::Float4),
        _ => None,
    }
}

pub fn translate_input_layout(elements: &[D3dInputElement]) -> Vec<raegfx::VertexBufferLayout> {
    let mut slots: BTreeMap<u32, Vec<raegfx::VertexAttribute>> = BTreeMap::new();
    ...
    for (location, elem) in elements.iter().enumerate() {
        ...
        let attr = raegfx::VertexAttribute {
    ...
    for (slot, attributes) in &slots {
        ...
        layouts.push(raegfx::VertexBufferLayout {
            stride,
            step_rate,
...
pub fn translate_constant_buffer_to_descriptor(
    ...
    buffer_handle: u64,
    size: u64,
) -> raegfx::DescriptorWrite {
    raegfx::DescriptorWrite {
        binding: slot,
        resource: raegfx::DescriptorResource::Buffer {
            handle: raegfx::BufferHandle(buffer_handle),
            offset: 0,
            size,
        },
    }
...
impl D3dTranslationLayer {
    ...
    pub fn translate_d3d11_draw_indexed(
        ...
        self.perf.record_draw_call();
        raegfx::DrawCommand::DrawIndexed {
            index_count,
            instance_count,
            first_index,
            vertex_offset,
    ...
    pub fn translate_d3d12_barriers(
        ...
        raegfx::DrawCommand::PipelineBarrier(translate_barriers_to_raegfx(barriers))
    }

    pub fn translate_buffer_desc(&self, desc: &D3d11BufferDesc) -> raegfx::BufferDescriptor {
    ...
    ) -> Option<raegfx::TextureDescriptor> {
        self.perf.record_state_change();
        desc.to_raegfx()
    }

    pub fn translate_rasterizer(&self, desc: &D3d11RasterizerDesc) -> raegfx::RasterState {
        self.perf.record_state_change();
        desc.to_raegfx()
    }

    pub fn translate_blend(&self, desc: &D3d11BlendDesc) -> raegfx::BlendState {
        self.perf.record_state_change();
        desc.to_raegfx()
    }
...
mod tests {
    ...
    fn test_format_mapping_comprehensive() {
        assert_eq!(
            DxgiFormat::R8G8B8A8_Unorm.to_raegfx(),
            Some(raegfx::PixelFormat::Rgba8Unorm)
        );
        assert_eq!(
            DxgiFormat::B8G8R8A8_Unorm_Srgb.to_raegfx(),
            Some(raegfx::PixelFormat::Bgra8Srgb)
        );
        assert_eq!(
            DxgiFormat::R16G16B16A16_Float.to_raegfx(),
            Some(raegfx::PixelFormat::Rgba16Float)
        );
        assert_eq!(
            DxgiFormat::D32_Float.to_raegfx(),
            Some(raegfx::PixelFormat::Depth32Float)
        );
        assert_eq!(
            DxgiFormat::BC7_Unorm.to_raegfx(),
            Some(raegfx::PixelFormat::Bc7Unorm)
        );
        assert_eq!(DxgiFormat::Unknown.to_raegfx(), None);
    }
    ...
    fn test_rasterizer_translation() {
        ...
        let rs = desc.to_raegfx();
        assert_eq!(rs.cull_mode, raegfx::CullMode::Front);
        assert_eq!(rs.polygon_mode, raegfx::PolygonMode::Line);
        assert_eq!(rs.front_face, raegfx::FrontFace::CounterClockwise);
    }
    ...
    fn test_blend_translation() {
        ...
        let bs = desc.to_raegfx();
        assert!(bs.enabled);
        assert_eq!(bs.src_factor, raegfx::BlendFactor::SrcAlpha);
        assert_eq!(bs.dst_factor, raegfx::BlendFactor::OneMinusSrcAlpha);
    }
    ...
    fn test_d3d12_barrier_translation() {
        ...
        let info = barrier.to_raegfx_barrier_info();
        assert_eq!(info.src_stage, raegfx::PipelineStage::ColorAttachmentOutput);
        assert_eq!(info.image_barriers.len(), 1);
        assert_eq!(
            info.image_barriers[0].old_layout,
            raegfx::ImageLayout::ColorAttachment
        );
        assert_eq!(
            info.image_barriers[0].new_layout,
            raegfx::ImageLayout::PresentSrc
        );
    }
