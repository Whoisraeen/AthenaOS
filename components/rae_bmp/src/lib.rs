...
//! file is the primary proof (run `cargo test -p rae_bmp`).
...
pub enum IconKind {
    ...
    /// decoder. A browser routes this to `raemedia::decode_png`.
    Png(Vec<u8>),
}
...
// ════════════════════════════════════════════════════════════════════════════
// Host KAT suite — `cargo test -p rae_bmp`. FAIL-able by construction.
// ════════════════════════════════════════════════════════════════════════════
#[cfg(test)]
mod tests {
    use super::*;
