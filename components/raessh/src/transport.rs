...
//! exchange switches on. Pure logic on `rae_crypto`'s KAT-verified ChaCha20 +
...
use crate::SshError;
use alloc::vec::Vec;
use rae_crypto::chacha20poly1305::{chacha20_xor, poly1305_mac};
...
mod tests {
    ...
    // Anchor the nonce/counter mapping to rae_crypto's RFC-8439-KAT'd ChaCha20:
