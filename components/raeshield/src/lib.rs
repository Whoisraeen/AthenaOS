...
impl Certificate {
    ...
    pub fn sign(&mut self, issuer_seed: &[u8; 32]) {
        ...
        self.signature = rae_crypto::ed25519::sign(issuer_seed, &msg).to_vec();
    }
    ...
    fn signature_valid_under(&self, issuer_public_key: &[u8]) -> bool {
        ...
        rae_crypto::ed25519::verify(&pk, &self.signed_data(), &sig)
    }
}
...
pub fn verify_signature(
    ...
    match signature.algorithm {
        SigningAlgorithm::Ed25519 => {
            ...
            if !rae_crypto::ed25519::verify(&public_key, binary_hash, &sig) {
                return SigningResult::InvalidSignature;
            }
        }
...
mod codesign_verify_tests {
    ...
    fn ed25519_codesign_accepts_genuine_rejects_forged() {
        ...
        let sig = rae_crypto::ed25519::sign(&seed, &binary_hash);
        ...
        let wrong_pk = rae_crypto::ed25519::derive_public_key(&[9u8; 32]);
    ...
    fn make_cert(
        ...
        let pubkey = rae_crypto::ed25519::derive_public_key(key_seed);
    ...
    fn chain_requires_real_signatures_and_a_pinned_anchor() {
        ...
        let root_fp =
            SigningIdentity::compute_fingerprint(&rae_crypto::ed25519::derive_public_key(&root_s));
        let inter_fp =
            SigningIdentity::compute_fingerprint(&rae_crypto::ed25519::derive_public_key(&inter_s));
