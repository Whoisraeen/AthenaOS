...
//! the `ath_regex` engine); their honest flag/feature scope is documented there.
...
// Harvested from the proven ath_calc implementations (Newton sqrt, Taylor sin/cos,
...
/// throws URIError here; ath_js has no URIError variant so it uses Error).
