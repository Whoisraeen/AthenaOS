// ════════════════════════════════════════════════════════════════════════════
// Host KAT suite — `cargo test -p ath_xlsx`. FAIL-able by construction.
//
...
fn writer_dedup_single_sst_entry() {
    ...
    let ar = ath_zip::Archive::open(&written).expect("archive opens");
    let sst_entry = ar
...
fn writer_xml_special_escaping() {
    ...
    let ar = ath_zip::Archive::open(&written).expect("archive");
