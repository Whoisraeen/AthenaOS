...
//! the `apps/music` player streams the result through `raekit::audio_submit`
...
// ═══════════════════════════════════════════════════════════════════════════
// Host KATs (cargo test -p raemedia). A from-scratch WAV writer builds each
...
mod tests {
    ...
    // ── Deterministic seeded-PRNG fuzz (cargo test -p raemedia) ─────────────────
    //
