...
//!
//! Why its own crate (the `ath_calc` / `ath_tokens` pattern): `apps/clock` is a
//! `#![no_main]` bin that links athkit's `#[panic_handler]`, so `cargo test`
...
//! `cfg(test)` gives a clean FAIL-able proof: `cargo test -p ath_time`.
//!
...
/// athlocale table) can synthesize custom locales.
...
// ───────────────────────────────────────────────────────────────────────────
// Host KATs — the FAIL-able proof: `cargo test -p ath_time`
// ───────────────────────────────────────────────────────────────────────────
