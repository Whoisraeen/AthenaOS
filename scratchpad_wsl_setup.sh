...
git fetch --no-tags --force /mnt/r/Projects/AthenaOS/.git main:refs/heads/amdgpu-run 2>&1 | tail -3
...
git apply --stat /mnt/r/Projects/AthenaOS/scratchpad-cap-fix.patch
git apply /mnt/r/Projects/AthenaOS/scratchpad-cap-fix.patch
