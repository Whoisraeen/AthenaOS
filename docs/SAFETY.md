...
- Capability engine today: `components/raeshield/` (RaeShield lineage)
- Kernel enforcement: capability checks on privileged syscalls (inherited AthKernel / RaeKernel path)
