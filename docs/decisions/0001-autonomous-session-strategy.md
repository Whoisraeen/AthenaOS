...
recent userspace-build break (athgfx VkPhysicalDeviceFeatures) that was repaired. Many backlog
...
1. Establish a verified-green baseline first. Before delegating feature work, athena-verifier does
...
2. UI marquee loop (highest fan-out + visibility): design-researcher refreshes per-surface specs
   in docs/design/; athena-ui / athena-gfx / athena-shell-apps implement; athena-visual-qa critiques.
