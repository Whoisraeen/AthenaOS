...
- DirectX 11/12 → AthGFX translation at the driver level (DXVK / VKD3D-Proton lineage)
...
- Native-feel: Win32 windows route through AthUI's compositor, so they get glass,
...
- Anti-cheat compatibility — pairs with AthGuard's attestation pitch
